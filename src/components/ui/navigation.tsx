            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center gap-4">
                        ...
                        />
                        <span className="text-xl font-semibold">Mark Roche</span>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <a href="#work" className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">Experience</a>
                        <a href="#skills" className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">Skills</a>
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-white dark:bg-slate-900 py-4">
                    <div className="container mx-auto px-4 space-y-4">
                        ...
                        <a href="#work" className="block text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">Experience</a>
                        <a href="#skills" className="block text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white">Skills</a>
